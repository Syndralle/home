...
def count_coins(total):
    ...
    def count_partition(n, m):
        ...
        if n == 0:
            ...
            return count_partition(n - m, m) + count_partition(n, next_larger_coin(m))
...
def move_stack(n, start, end):
    ...
    if n == 1:
        ...
        move_stack(n - 1, start, abs(6 - end - start))
        move_stack(1, start, end)
        move_stack(n - 1, abs(6 - end - start), end)
...
def make_anonymous_factorial():
    ...
    return lambda n: (lambda n, f: 1 if n == 1 else n * f(n - 1, f))(
        n, lambda n, f: 1 if n == 1 else n * f(n - 1, f)
    )
